            ...
            <footer className="footer">
                ...
                <div className="column">
                    ...
                    <div className="contact-item" onClick={() => openModal("О нас", 
                        "Мы работаем с 2008 года и знаем, какие материалы действительно нужны для сельского строительства. " 
                    ...
                    <div className="contact-item" onClick={() => openModal("График работы", 
                        "Обеденный перерыв: 13:00-14:00 (просьба в это время не беспокоить)\n"
                    ...
                    <div className="contact-item" onClick={() => openModal("Доставка и оплата", 
                        "Доставка в селе Чекмагуш - бесплатная.\n По остальным населенным пунктам уточнять информацию у продавцов или посмотреть о стоимости доставки при оформлении заказа.\n\n"
